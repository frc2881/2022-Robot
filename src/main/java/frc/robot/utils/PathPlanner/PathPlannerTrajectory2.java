...
public class PathPlannerTrajectory2 extends Trajectory {
    protected PathPlannerTrajectory2(ArrayList<Waypoint> pathPoints, double maxVel, double maxAccel, boolean reversed){
        super(generatePath(pathPoints, maxVel, maxAccel, reversed));
    }

    protected PathPlannerTrajectory2(List<State> states){
        super(states);
    }
    ...
    private static ArrayList<PathPlannerState> joinSplines(ArrayList<Waypoint> pathPoints, double maxVel, double step){
        ...
        for(int i = 0; i < numSplines; i++){
            ...
            for(double t = 0; t <= endStep; t += step){
                Translation2d p = GeometryUtil2.cubicLerp(startPoint.anchorPoint, startPoint.nextControl, endPoint.prevControl, endPoint.anchorPoint, t);
    ...
    public static class PathPlannerState extends State{
        ...
        private PathPlannerState interpolate(PathPlannerState endVal, double t){
            ...
            lerpedState.timeSeconds = GeometryUtil2.doubleLerp(timeSeconds, endVal.timeSeconds, t);
            ...
            Rotation2d newHeading = GeometryUtil2.rotationLerp(poseMeters.getRotation(), endVal.poseMeters.getRotation(), t);
            lerpedState.poseMeters = new Pose2d(newTrans, newHeading);
            lerpedState.angularVelocity = GeometryUtil2.rotationLerp(angularVelocity, endVal.angularVelocity, t);
            lerpedState.angularAcceleration = GeometryUtil2.rotationLerp(angularAcceleration, endVal.angularAcceleration, t);
            lerpedState.holonomicRotation = GeometryUtil2.rotationLerp(holonomicRotation, endVal.holonomicRotation, t);
            lerpedState.curveRadius = GeometryUtil2.doubleLerp(curveRadius, endVal.curveRadius, t);
            lerpedState.curvatureRadPerMeter = GeometryUtil2.doubleLerp(curvatureRadPerMeter, endVal.curvatureRadPerMeter, t);
